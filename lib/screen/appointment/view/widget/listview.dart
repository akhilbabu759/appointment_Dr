            ...
            child: Column(
              ...
              children: [
                ...
                Expanded(
                  ...
                  itemCount: tile == 'Day'
                      ? date.length
                      : model[0].availability[controller.click]!.length,
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: GestureDetector(
                        onTap: () {
                          tile == 'Day'
                              ? controller.dateUpdate(date[index])
                              : controller.timeUpdate(model[0]
                                  .availability[controller.click]![index]
                                  .substring(0, 8));
                        },
                        child: Container(
                          decoration: BoxDecoration(
                              border: Border.all(
                                  color: AppColors().grCle, width: 0.3),
                              color: tile == 'Day'
                                  ? controller.click == date[index]
                                      ? AppColors().bluCle
                                      : Colors.white
                                  : model[0]
                                              .availability[controller.click]![
                                                  index]
                                              .substring(0, 8) ==
                                            ...
                                            : date[index] == '2023-09-19'
                                                ...
                                                : date[index] == '2023-09-20'
                                                    ...
                                                    : date[index] ==
                                                        ...
                                                        ? 'Thu'
                                                        : ''
                                        // formatDateToHumanReadable(date[index])//given api value is not correct so i giveing default value
                                        // 'Today'
                                        ,
                                        style: TextStyle(
                                            color:
...
String formatDateToHumanReadable(String inputDate) {
  final DateTime date = DateTime.parse(inputDate);
